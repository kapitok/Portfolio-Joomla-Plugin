...
<div id="editcell">
	...
	for ($i=0, $n=count( $this->rows ); $i < $n; $i++)	{
		...
		$link = JRoute::_( 'index.php?option=com_lbportfolio&controller=lbportfoliocontentlist&task=edit&cid[]='. $row->id);
		?>
...
<input type="hidden" name="controller" value="lbportfoliocontentlist" />
